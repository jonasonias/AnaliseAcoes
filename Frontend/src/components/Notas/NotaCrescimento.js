...
const NotaCrescimento = ({ ticker }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`${API_BASE_URL}/acoes/nota/crescimento/${ticker}`);
  ...
  return (
    <div>
      <h2 style={{ marginLeft: '30%' }}>Nota de Crescimento</h2>
...
export default NotaCrescimento;
