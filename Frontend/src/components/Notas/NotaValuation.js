...
const NotaValuation = ({ ticker }) => {
  ...
  return (
    <div>
      <h2 style={{ marginLeft: '13%' }}>Nota de Valuation</h2>
      <table style={{ width: '40%', borderCollapse: 'collapse', margin: '0 0' }}>
        <thead>
          <tr>
      ...
      <div style={{ textAlign: 'left', marginTop: '22px', marginLeft: '180px' }}>
